...
OPTIONS.popsize = 100; % pop size -----% total population size
OPTIONS.Maxgen = 20; % iterations -----% generation count limit
OPTIONS.numVar = 10; % dimension -----% number of genes in each population member
